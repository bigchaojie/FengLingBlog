...
public class AdminResourceInterceptor implements WebRequestInterceptor {
    ...
    public void preHandle(WebRequest request) {
        log.info( "AdminResourceInterceptor..用户资源拦截器处理请求之前" );
    ...
    public void postHandle(WebRequest request, ModelMap map) {
        log.info( "AdminResourceInterceptor..用户资源拦截器postHandle.......controller执行之后" );
    }
    ...
    public void afterCompletion(WebRequest request, Exception exception) {
        log.info( "AdminResourceInterceptor..用户资源拦截器afterCompletion资源释放" );
    }
