...
import com.houchaojie.blog.entity.Menu;
...
public class HomeResourceInterceptor implements WebRequestInterceptor {
    ...
    private static final Logger logger = Logger.getLogger( HomeResourceInterceptor.class );
    ...
    public void preHandle(WebRequest request) {
        logger.info( "HomeResourceInterceptor...preHandle......" );
        logger.info( ((DispatcherServletWebRequest) request).getRequest().getRequestURI() );
...
//         分类显示
    ...
    public void postHandle(WebRequest request, ModelMap map) {
        logger.info( "HomeResourceInterceptor..postHandle......." );
    }
    ...
    public void afterCompletion(WebRequest request, Exception exception) {
        logger.info( "HomeResourceInterceptor...afterCompletion" );
    }
